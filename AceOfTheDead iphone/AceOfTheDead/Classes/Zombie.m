...
@synthesize animStandingUpUpUp;
@synthesize animStandingUpUpRight;
@synthesize animStandingUpRightRight;
@synthesize animStandingRightRightRight;
@synthesize animStandingDownRightRight;
@synthesize animStandingDownDownRight;
@synthesize animStandingDownDownDown;
@synthesize animStandingDownDownLeft;
@synthesize animStandingDownLeftLeft;
@synthesize animStandingLeftLeftLeft;
@synthesize animStandingUpLeftLeft;
@synthesize animStandingUpUpLeft;
...
{
    CCSprite *tmpSprite = [[CCSprite alloc] initWithFile:@"boosterCloud0010.png"];

    tmpSprite.anchorPoint = ccp(0.5, 0);
    tmpSprite.position = ccp(35,60);
    icon.position = ccp(32,95);
//    [self addChild:tmpSprite z:20];
//    [self addChild:icon z:21];
    
    BoosterCloud *boosterCloudAnim = [[BoosterCloud alloc] init];
    boosterCloudAnim.position = ccp(32,95);
    [self addChild:boosterCloudAnim z:20];
    [boosterCloudAnim showCloudAnimation];
//    [self addChild:tmpSpriteAnimation z:22];
//    [self stopAllActions];
...
-(void)changeState:(CharacterStates)newState
{
    ...
    switch (newState) {
        ...
        case kStateStanding:
            ...
            action = [CCAnimate actionWithAnimation:animStandingDownDownDown
                               restoreOriginalFrame:NO];
...
-(void)initAnimations
{
    ...
    [self initStandingAnimation];
    [self initBoosterCloudAnimation];
...
{    
    [self setAnimWalkingUpUpUp : [[self loadPlistForAnimationWithName:
                                   @"walk" andClassName:@"zombieWalk"
                                                         andDirection:ksDirectionUpUpUp] objectForKey: LABEL_ANIMATION]];

    [self setAnimWalkingUpUpLeft : [[self loadPlistForAnimationWithName:
                                   @"walk" andClassName:@"zombieWalk"
                                                         andDirection:ksDirectionUpUpLeft] objectForKey: LABEL_ANIMATION]];
...
//                            @"boosterCloud" andClassName:kBoosterCloudClassName
//                                                  andDirection:@"default"] objectForKey: LABEL_ANIMATION] ];
}

-(void)initStandingAnimation
{
    [self setAnimStandingUpUpUp : [[self loadPlistForAnimationWithName:
                                   @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionUpUpUp] objectForKey: LABEL_ANIMATION]];
    
    [self setAnimStandingUpUpLeft : [[self loadPlistForAnimationWithName:
                                     @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionUpUpLeft] objectForKey: LABEL_ANIMATION]];
    
    [self setAnimStandingUpLeftLeft:[[self loadPlistForAnimationWithName:
                                     @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionUpLeftLeft] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingUpUpRight:[[self loadPlistForAnimationWithName:
                                    @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionUpUpRight] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingUpRightRight:[[self loadPlistForAnimationWithName:
                                       @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionUpRightRight] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingDownDownDown:[[self loadPlistForAnimationWithName:
                                       @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionDownDownDown] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingDownDownLeft:[[self loadPlistForAnimationWithName:
                                       @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionDownDownLeft] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingDownLeftLeft:[[self loadPlistForAnimationWithName:
                                       @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionDownLeftLeft] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingLeftLeftLeft:[[self loadPlistForAnimationWithName:
                                       @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionLeftLeftLeft] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingDownDownRight:[[self loadPlistForAnimationWithName:
                                        @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionDownDownRight] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingDownRightRight:[[self loadPlistForAnimationWithName:
                                         @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionDownRightRight] objectForKey: LABEL_ANIMATION] ];
    
    [self setAnimStandingRightRightRight:[[self loadPlistForAnimationWithName:
                                          @"stand" andClassName:@"zombieStand"
                                        andDirection:ksDirectionRightRightRight] objectForKey: LABEL_ANIMATION] ];
...
-(id) init {
    if( (self=[super init]) ) {
        ...
        [self useBoosterWithIcon: [[CCSprite alloc] initWithFile:@"moustache32.png"]];
    }
    return self;
}
@end