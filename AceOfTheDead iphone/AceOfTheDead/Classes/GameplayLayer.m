               ...
               withZValue:(int)ZValue
{
    ...
    else if (objectType == kEnemyTypeWillie)
    {
        ...
        for (int i=0; i<100; i++)
        {
            ...
            [arrTmpPathHolder addObject:[NSValue valueWithCGPoint:ccp(368, 90)]];
        }
        ...
        if (self != nil)
        {
            ...
            else
            {
                [[CCSpriteFrameCache sharedSpriteFrameCache]
                                     addSpriteFramesWithFile:@"zombieWalk.plist"];
                [[CCSpriteFrameCache sharedSpriteFrameCache]
                                     addSpriteFramesWithFile:@"zombieStand.plist"];
                [[CCSpriteFrameCache sharedSpriteFrameCache]
                ...
                [[CCSpriteFrameCache sharedSpriteFrameCache]
                                     addSpriteFramesWithFile:@"boosterCloud.plist"];
            ...
            food = [[Health alloc] initWithSpriteFrame:[[CCSpriteFrameCache
                                            sharedSpriteFrameCache]
                                           spriteFrameByName:@"burger01_20.png"]];
